...
Tiller is free software under the [MIT](LICENSE).

Feel free to open bug issues, and create PR's to fix them. If you add PR's, please provide the plan, and the model and effort used to both create the plan and implement it. Until beta, please don't add feature requests. If you want to help fix the architecture, open a discussion.
