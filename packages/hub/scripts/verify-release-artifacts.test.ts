...
describe("release artifact verification", () => {
  ...
  beforeEach(async () => {
    ...
    const descriptor = {
      ...
      version: "0.3.0",
      releaseNotesUrl:
        "https://github.com/paperwing-dev/tiller/releases/tag/tiller-hub-v0.3.0",
      bundle: {
        url: "https://github.com/paperwing-dev/tiller/releases/download/tiller-hub-v0.3.0/tiller-hub-v0.3.0.tar.gz",
  ...
  it("verifies the exact published bytes before installer deployment", async () => {
    ...
    await expect(
      ...
      descriptorUrl:
        "https://github.com/paperwing-dev/tiller/releases/download/tiller-hub-v0.3.0/release-descriptor.json",
      size: 6,
