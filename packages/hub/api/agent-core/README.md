...
review flows use planner or environment-review runs instead, and the Worker
does not dispatch `/agents/*` requests to this harness.
...
- Do not add new product flows here; plan review behavior belongs under
  `api/planner/`, and implementation review behavior belongs under
  `api/env-review/`.
